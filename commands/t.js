exports.run = async (client, message, args) => {
  if(!message.member.hasPermission("MANAGE_MESSAGES")) return message.channel.send("Nemaš permisiju za korištenje ove komande!");
  ...
  if(channel === undefined) return message.channel.send("Nisi postavio/la zadani kanal za bota!");
  ...
  let pozicija = "moderator";
  if(message.member.hasPermission("BAN_MEMBERS") && message.author.id !== message.guild.ownerID) pozicija = "admin";
